...
export function useDuel() {
  ...
  return { duel, loading, myRole: duel ? myRole(duel) : null, createDuel, inviteDuel, respondInvite, cancelInvite, joinDuel, playCell, passTurn, forfeit, clearFinished, refresh: loadActive };
}
