...
const GAMES: GameDef[] = [
  { id: 'main', icon: '🎯', labelKey: 'jeux_game_main', descKey: 'jeux_game_main_desc', modes: { solo: true, duel: false, group: true } },
...
export default function JeuxScreen() {
  ...
  if (selectedGame && selectedMode) {
    ...
    if (selectedGame === 'main' && selectedMode === 'group') return <GroupGameScreen onBack={backToModes} />;
