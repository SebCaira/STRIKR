...
export type TabParamList = {
  Home: undefined;
  // autoCreate: set by LeagueScreen's "challenge" button so DuelScreen can
  // create a fresh duel itself — keeps useDuel() single-instance rather than
  // running a second copy (with its own realtime subscription) in League.
  Duel: { autoCreate?: boolean } | undefined;
  Game: undefined;
  League: undefined;
  Profil: undefined;
};
