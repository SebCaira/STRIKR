...
export type TabParamList = {
  Home: undefined;
  // inviteUserId/inviteUserName: set by LeagueScreen's "challenge" button so
  // DuelScreen can send the invite itself — keeps useDuel() single-instance
  // rather than running a second copy (with its own realtime subscription)
  // in League.
  Duel: { inviteUserId?: string; inviteUserName?: string } | undefined;
  Game: undefined;
  League: undefined;
  Profil: undefined;
};
