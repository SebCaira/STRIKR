...
// Liste/XI Type) — a thin circular border instead of the thick rectangular
// "card" frame, which looks disproportionate much below its 200px default.
  ...
  return (
    <View
      style={
        isAvatar
          ? {
              width: size, height: size, borderRadius: size / 2, backgroundColor: '#1a1a1a',
              borderWidth: 1.5, borderColor, overflow: 'hidden', alignItems: 'center', justifyContent: 'center',
            }
          : {
