...
export default function LeagueScreen() {
  ...
  // tab that stays mounted) — this just hands it a signal to create a duel,
  // rather than running a second useDuel() here with its own realtime
  // subscription racing the one already live in the Duel tab.
  const challengeFriend = () => {
    navigation.navigate('Duel', { autoCreate: true });
  };
