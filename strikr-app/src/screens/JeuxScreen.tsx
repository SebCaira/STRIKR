...
const GAMES: GameDef[] = [
  ...
  { id: 'club', icon: '🏟️', labelKey: 'jeux_game_club', descKey: 'jeux_game_club_desc', modes: { solo: true, duel: true, group: false } },
  { id: 'liste', icon: '📝', labelKey: 'jeux_game_liste', descKey: 'jeux_game_liste_desc', modes: { solo: true, duel: true, group: false } },
];
