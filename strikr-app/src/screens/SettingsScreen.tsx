...
export default function SettingsScreen() {
  ...
  const saveRecoveryEmail = async () => {
    ...
    setRecoveryMessage(error ? error.message : t('auth_recovery_email_saved'));
  };
    ...
    <View style={{ flex: 1, backgroundColor: colors.bg, paddingTop: insets.top + 14 }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, gap: 16 }}>
        ...
        <View>
          ...
          <View style={{ gap: 6 }}>
            <ToggleRow icon="🔔" label={t('settings_notif')} value={settings.notificationsEnabled} onChange={setNotificationsEnabled} />
